        ...
        <div class="container">
            ...
            <form action="" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Sulaiman Awwal" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 070xxxxxx" class="input-responsive" required>
